...
import { rejectApplicationSchema, rejectApplicationErrorCodes, applyTournamentSchema } from '../schemas/application.schema.js';
...
router.post('/applications/:id/reject' , requireAuth , validate(rejectApplicationSchema, rejectApplicationErrorCodes) , Application.rejectApplication)
