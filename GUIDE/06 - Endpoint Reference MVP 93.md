...
| `ORGANIZER_STILL_HAS_TIME` | 403 | S04: แอดมินกดเร็วไป ผู้จัดยังมีเวลาตัดสินถึง `extra.availableAt` |
